...
<body style="margin: 0; padding: 0; background: #1c1917; font-family: Arial, sans-serif;">
  <div style="max-width: 560px; margin: 0 auto; background: #1c1917;">
    ...
    <div style="padding: 40px; background: #292524;">
      ...
      <!-- Waiver -->
      <div style="margin-bottom: 24px;">
        <p style="color: #fafaf9; font-size: 14px; font-weight: 600; margin: 0 0 12px;">Before You Arrive</p>
        <p style="color: #d6d3d1; font-size: 14px; line-height: 1.6; margin: 0;">
          Please fill out our <a href="https://forms.gle/DszFyex1HKBbLDw6A" style="color: #f87171; text-decoration: none;">liability waiver</a> before you come. It only takes a minute and helps us get started right away!
        </p>
      </div>
