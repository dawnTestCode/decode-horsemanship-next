    ...
    <section className="py-16 px-4 bg-black border-b border-stone-800">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-2xl md:text-3xl font-serif text-[#f5f0e8] mb-6">
          Not wanting to make a regular commitment, but want to spend some time with horses?
        </h2>
        <p className="text-lg text-stone-400 mb-8">
          Start smaller. Single-day experiences — No Reins, Groundwork, Dust & Leather, and Copper & Lace — are low-commitment ways to find out if this is for you before you book ongoing lessons.
        </p>
        <Link
          href="/experiences"
