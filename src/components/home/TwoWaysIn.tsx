    ...
    <section className="py-16 px-4 bg-black border-b border-stone-800">
      <div className="max-w-4xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8">
          <Link href="/lessons/decode-the-desire" className="bg-stone-900/50 p-8 rounded-xl border border-stone-800 hover:border-red-700 transition-colors">
