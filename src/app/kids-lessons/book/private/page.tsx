...
export default function BookKidsPrivateLessonPage() {
  return (
      ...
      <section className="relative py-16 md:py-20 px-4" style={{ background: 'linear-gradient(180deg, #0c0a09 0%, #150c0c 100%)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-[#b8a8a0] max-w-3xl mb-4">
            One-on-one instruction, fully paced to your kid.
          </p>
          <p className="text-sm text-[#a89890]">
            ...
            {' · '}
            <Link href="/kids-lessons/book/homeschool" className="text-[#dc143c] hover:underline">
              Homeschool Group Block
            </Link>
          </p>
        </div>
      </section>
      ...
      <section className="pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#150c0c] rounded-xl border border-[#3a2020] overflow-hidden">
            <iframe
              src="https://app.acuityscheduling.com/schedule.php?owner=39789893&appointmentType=96034297&ref=embedded_csp"
              title="Schedule Kids Private Lesson"
              width="100%"
              height="800"
              frameBorder="0"
              allow="payment"
