...
export default function BookKidsSmallGroupPage() {
  return (
      ...
      <section className="pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#150c0c] rounded-xl border border-[#3a2020] overflow-hidden">
            <iframe
              src="https://app.acuityscheduling.com/schedule.php?owner=39789893&appointmentType=96034331&ref=embedded_csp"
              title="Schedule Kids Small Group Lesson"
              width="100%"
              height="800"
              frameBorder="0"
              allow="payment"
