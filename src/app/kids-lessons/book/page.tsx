...
export default function BookKidsLessonPage() {
  return (
      ...
      <section className="relative py-16 md:py-20 px-4" style={{ background: 'linear-gradient(180deg, #0c0a09 0%, #150c0c 100%)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-[#b8a8a0] max-w-3xl mb-4">
            Tell us a little about your child, and we&apos;ll go from there.
          </p>
          <p className="text-sm text-[#a89890]">
            Booking for yourself, not your kid?{' '}
            <Link href="/lessons/book" className="text-[#dc143c] hover:underline">
              Book adult lessons here
            </Link>
          </p>
        </div>
      </section>
